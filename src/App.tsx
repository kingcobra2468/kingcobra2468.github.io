  ...
  return (
    <div className='App w-screen h-screen'>
      <div className='flex h-screen flex-wrap content-start flex-row'>
        <div className='w-full h-12 justify-center md:justify-start flex items-start flex-row-reverse pt-1 sn:pr-5'>
          <img src={gmailLogo} alt="Github link" className="w-10 h-10 mx-5 md:mr-10"/>
          <img src={linkedInLogo} alt="Github link" className="w-8 h-8 mx-5 md:mr-10"/>
          <img src={githubLogo} alt="Github link" className="w-9 h-9 mx-5 md:mr-10"/>
        </div>
        <div className='w-100 h-4/6 sm:w-70 lg:w-60 flex-auto flex flex-col items-center justify-center max-w-4xl'>
          <div id='info' className='h-3/6 w-4/5 p-12 min-h-[300px] max-h-96 bg-clip-padding bg-white bg-opacity-10 backdrop-filter-lg drop-shadow-lg backdrop-blur-lg rounded-3xl'>
            ...
            <h3 className='neon-text description text-1xl sm:text-2xl text-grsay-300 text-left mt-6'>Turning ideas into reality</h3>
          </div>
        </div>
